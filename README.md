...
**`articles/drafts/` に置いてよいのは「公開すると決めたもの」だけ。** 本リポジトリは public なので、Draft PR であっても草案は誰でも読めます。書くと決めていないネタ、公開留保がかかったもの、取り下げたものは、リポジトリ外（Stock ノート等）で別管理しています（[AGENTS.md](./AGENTS.md) §2）。
